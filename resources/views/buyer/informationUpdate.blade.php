            ...
            <div class="bg-gray-100 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mx-30 my-10">
                <div class="grid grid-cols-1 md:grid-cols-1 ">
                    <div class="bg-white p-4 rounded-lg">
                        ...
                        <form method="POST" action="{{ route('buyer.information.update',Auth::user()->id) }}">
                            @csrf
                            @method('put')
                            <!-- bank account -->
                            <div>
                                <x-input-label for="bank_account" :value="__('bank_account')" />
                                <x-text-input id="bank_account" class="block my-2 w-full" type="text" name="bank_account" :value="old('bank_account', $buyer['bank_account'])" required autofocus autocomplete="bank_account" />
