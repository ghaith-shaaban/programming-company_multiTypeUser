...
use App\Http\Controllers\buyer\informationController;
use Illuminate\Support\Facades\Route;



    route::group(['prefix'=>'buyers/information','as'=>'buyer.information.','middleware'=>['auth', 'verified','can:buyer']] ,function(){
